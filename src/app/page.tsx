    ...
    <div className="min-h-screen">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button className="px-8 py-4 bg-gradient-to-r from-neon-blue to-neon-green text-black font-bold text-lg rounded-xl hover:shadow-neon-blue transition-all duration-300 transform hover:scale-105">
              Get Started Now
            </button>
            <button className="px-8 py-4 border-2 border-neon-blue text-neon-blue font-bold text-lg rounded-xl hover:bg-neon-blue/10 transition-all duration-300 neon-border">
              Try AI Assistant
            </button>
          </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-r from-neon-blue/10 to-neon-green/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="inline-block px-12 py-4 bg-gradient-to-r from-neon-blue to-neon-green text-black font-bold text-xl rounded-xl hover:shadow-rockstar-glow transition-all duration-300 transform hover:scale-105">
